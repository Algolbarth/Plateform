...
export class Character {
    ...
    move = function (System) {
        let listObjet = [];
        for (let n = 0; n < System.map.objets.length; n++) {
            listObjet.push(System.map.objets[n]);
        }
        let listEntity = [];
        ...
        for (let n = 0; n < listObjet.length; n++) {
            if (System.checkCollision(System.character, listObjet[n])) {
                listObjet[n].collision_x(System.character, move_x);
            }
        }
        ...
        for (let n = 0; n < listObjet.length; n++) {
            if (System.checkCollision(System.character, listObjet[n])) {
                listObjet[n].collision_y(System.character);
            }
        }
        for (let n = 0; n < listEntity.length; n++) {
            if (System.checkCollision(System.character, listEntity[n])) {
        ...
        for (let n = 0; n < listObjet.length; n++) {
            if (System.checkCollision(System.character, listObjet[n])) {
                listObjet[n].collision(System.character);
            }
        }
        for (let n = 0; n < listEntity.length; n++) {
            if (System.checkCollision(System.character, listEntity[n])) {

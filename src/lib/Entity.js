export class Entity {
    ...
    move = function () {
        let listObjet = [];
        for (let n = 0; n < this.System.map.objets.length; n++) {
            listObjet.push(this.System.map.objets[n]);
        }
        let listEntity = [];
        ...
        for (let n = 0; n < listObjet.length; n++) {
            if (this.System.checkCollision(this, listObjet[n])) {
                listObjet[n].collision_x(this, this.move_x);
            }
        }
